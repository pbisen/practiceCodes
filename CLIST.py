...
#URL - response
url = "https://clist.by/api/v1/json/contest/" + "c2cd876193d5fb2650d4a092e93dc9d015d290cb"
payload = "{}"
...
for j in range(j_count+1):
  k = str(j*1000)
  url = "https://clist.by/api/v1/json/contest/?limit="+total+"&offset="+k+"c2cd876193d5fb2650d4a092e93dc9d015d290cb"
  payload = "{}"
  response = requests.request("GET",url,data=payload)
  print("OFFSET:",k,"\n","RESPONSE:",response,"\n\n")
  a = response.text
